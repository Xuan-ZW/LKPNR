...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--device_id', type=int, default=3, help='Device ID of GPU')
        ...
        parser.add_argument('--max_linked_entity_length', type=int, default=20, help='max_linked_entity_length')
        parser.add_argument('--pretrain_emb_d', type=int, default=4096, help='llm emb')
        parser.add_argument('--pretrain_rep_d', type=int, default=500, help='llm representation')
        parser.add_argument('--pretrain_hidden_dim', type=int, default=1024, help='pretrain_hidden_dim')
        parser.add_argument('--entity_hidden_dim', type=int, default=256, help='pretrain_hidden_dim')

        parser.add_argument('--entity_att_head_num', type=int, default=3, help='entity_att_head_num')
        # Training config
        ...
        parser.add_argument('--entity_attention_dim', type=int, default=100, help="Attention dimension")
    ...
    def preliminary_setup(self):
        ...
        dataset_files = [
            self.train_root + '/news.tsv', self.train_root + '/behaviors.tsv', self.train_root + '/entity_embedding.vec', 
            self.dev_root + '/news.tsv', self.dev_root + '/behaviors.tsv', self.dev_root + '/entity_embedding.vec', 
            self.test_root + '/news.tsv', self.test_root + '/behaviors.tsv', self.test_root + '/entity_embedding.vec'
        ]
