...
class MIND_Corpus:
    ...
    def preprocess(config: Config):
        ...
        preprocessed_data_files = [user_ID_file, news_ID_file, category_file, subCategory_file, vocabulary_file, word_embedding_file, entity_file, entity_embedding_file, user_history_graph_file]
        
        # print(preprocessed_data_files)
